			        ...
			        "6x1",
			        {
			            ...
			            pressed: function () {
							...
							*/
							...
							var setBaseScaleResolution = function(baseScaleResolution) {
							
								setGlobalVariable("__baseScaleResolution", baseScaleResolution)
							}
							setBaseScaleResolution(baseScaleResolution);
