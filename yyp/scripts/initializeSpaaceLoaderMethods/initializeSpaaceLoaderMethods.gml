function initializeSpaaceLoaderContexts() {
...
function initializeSpaaceLoaderEnums() {
...
function initializeSpaaceLoaderException() {

    ///@todo
}

function initializeSpaaceLoaderGlobals() {
    ...
    ///@todo Remove
	///@type {Boolean}
	global.isHandheldMode = getPropertyBoolean("spaacerap.forceIsHandheld", false) ? true : isMobile();
...
function initializeSpaaceLoaderMacros() {

	#macro BASE_SCALE_RESOLUTION 1024
}

function initializeSpaaceLoaderManagers() {
...
function hardbaSS() {
	...
	return "let's talk about sewerslvt";
}
hardbaSS();
