///@function getAngleBetweenInstances(source, target)
///@description Getter.
///@param {Instance} source
///@param {Instance} target
///@return {Number} angle. Return NaN if any of the instances doesn't exists.
function getAngleBetweenInstances(argument0, argument1) {
		...
		return ((!isNumber(sourceX)) || (!isNumber(sourceY)) ||
			...
			NaN :
			point_direction(sourceX, sourceY, targetX, targetY);
