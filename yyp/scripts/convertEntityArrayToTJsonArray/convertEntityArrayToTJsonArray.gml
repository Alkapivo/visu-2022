///@function convertEntityArrayToTJsonArray(entities, entityName)
///@description Wrapper for entity collection and convertEntityToTJsonObject
///@param {Entity[]} entities
///@param {String} entityName
///@return {TJsonArray} tjsonArray
function convertEntityArrayToTJsonArray(argument0, argument1) {
		...
		var entitiesSize = getArrayLength(entities);
