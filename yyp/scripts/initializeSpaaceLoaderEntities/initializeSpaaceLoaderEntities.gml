///@function initializeSpaaceLoaderEntities()
...
function initializeSpaaceLoaderEntities() {
	...
	#macro SpaacePlayer 200212
	global.entityPrototypes[? SpaacePlayer] = 8;
	global.entityClassNames[? SpaacePlayer] = "SpaacePlayer";
